                        ...
                        <form method="POST" action="{{ route('villa.update',$villa->id) }}">
                            ...
                            <div class="pf-property-details">
                                ...
                                <div class="property-details-inputs">
                                    ...
                                    <input type="text" name="balcon"  value="{{ $villa->balcon }}" >
                                    <input type="text" name="chombre" value="{{ $villa->chombre }}">
                                    <input type="text" name="salledebain" value="{{ $villa->salledebain }}">
                                    <input type="text" name="etage"  value="{{ $villa->etage }}">
                                    <input type="text" name="toilettes" value="{{ $villa->toilettes }}">
                                    <input type="text" name="cuisine" value="{{ $villa->cuisine }}">
                                    <input type="text" name="garage" value="{{ $villa->garage }}">
                                </div>

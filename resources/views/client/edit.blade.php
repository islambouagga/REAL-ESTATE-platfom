...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Edit assistant') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('client.update',$client->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tel" type="text" class="form-control @error('tel') is-invalid @enderror" name="tel" value="{{ $client->tel }}" required autocomplete="tel" autofocus>
                        ...
                        <input type="hidden" name="usertable_type" value="Assistant">
                        <div class="form-group row">

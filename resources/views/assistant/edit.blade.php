                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('assistant.update',$assistant->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ $assistant->address }}" required autocomplete="address" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tel" type="text" class="form-control @error('tel') is-invalid @enderror" name="tel" value="{{ $assistant->tel }}" required autocomplete="tel" autofocus>
